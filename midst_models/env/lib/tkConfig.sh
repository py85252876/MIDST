...
# installed.
TK_PREFIX='/bigtemp/trv3px/MIDSTModels/midst_models/env'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/bigtemp/trv3px/MIDSTModels/midst_models/env'
...
# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/bigtemp/trv3px/MIDSTModels/midst_models/env/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/bigtemp/trv3px/MIDSTModels/midst_models/env/include'
...
# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/bigtemp/trv3px/MIDSTModels/midst_models/env/lib -ltkstub8.6'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/croot/tk_1714770549989/work/tk8.6.14/unix/libtkstub8.6.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/bigtemp/trv3px/MIDSTModels/midst_models/env/lib/libtkstub8.6.a'
