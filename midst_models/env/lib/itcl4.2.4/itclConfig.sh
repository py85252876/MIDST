...
# String to pass to linker to pick up the Itcl library from its
# installed directory.
itcl_LIB_SPEC='-L/bigtemp/trv3px/MIDSTModels/midst_models/env/lib/itcl4.2.4 -litcl4.2.4'
ITCL_LIB_SPEC='-L/bigtemp/trv3px/MIDSTModels/midst_models/env/lib/itcl4.2.4 -litcl4.2.4'
...
# String to pass to linker to pick up the Itcl stub library from its
# installed directory.
itcl_STUB_LIB_SPEC='-L/bigtemp/trv3px/MIDSTModels/midst_models/env/lib/itcl4.2.4 -litclstub4.2.4'
ITCL_STUB_LIB_SPEC='-L/bigtemp/trv3px/MIDSTModels/midst_models/env/lib/itcl4.2.4 -litclstub4.2.4'
...
# String to pass to linker to pick up the Itcl stub library from its
# installed directory.
itcl_STUB_LIB_PATH='/bigtemp/trv3px/MIDSTModels/midst_models/env/lib/itcl4.2.4/libitclstub4.2.4.a'
ITCL_STUB_LIB_PATH='/bigtemp/trv3px/MIDSTModels/midst_models/env/lib/itcl4.2.4/libitclstub4.2.4.a'
