...
# installed.
TCL_PREFIX='/bigtemp/trv3px/MIDSTModels/midst_models/env'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/bigtemp/trv3px/MIDSTModels/midst_models/env'
...
TCL_EXTRA_CFLAGS='-march=nocona -mtune=haswell -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O2 -ffunction-sections -pipe -isystem /bigtemp/trv3px/MIDSTModels/midst_models/env/include -fdebug-prefix-map=/croot/tk_1714770549989/work=/usr/local/src/conda/tk-8.6.14 -fdebug-prefix-map=/bigtemp/trv3px/MIDSTModels/midst_models/env=/usr/local/src/conda-prefix -pipe -m64 -DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem /bigtemp/trv3px/MIDSTModels/midst_models/env/include'
...
TCL_LD_FLAGS='-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,--disable-new-dtags -Wl,--gc-sections -Wl,-rpath,/bigtemp/trv3px/MIDSTModels/midst_models/env/lib -Wl,-rpath-link,/bigtemp/trv3px/MIDSTModels/midst_models/env/lib -L/bigtemp/trv3px/MIDSTModels/midst_models/env/lib -Wl,--export-dynamic '
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/bigtemp/trv3px/MIDSTModels/midst_models/env/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/bigtemp/trv3px/MIDSTModels/midst_models/env/include'
...
TCL_PACKAGE_PATH='{/bigtemp/trv3px/MIDSTModels/midst_models/env/lib} '
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/bigtemp/trv3px/MIDSTModels/midst_models/env/lib -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/croot/tk_1714770549989/work/tcl8.6.14/unix/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/bigtemp/trv3px/MIDSTModels/midst_models/env/lib/libtclstub8.6.a'
