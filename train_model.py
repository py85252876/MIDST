...
train_data = torch.load("./train_data.pt")  # shape: [5800, 20]
train_label = torch.load("./train_label.pt")  # shape: [5800]


test_data = train_data[5800:, :] 
test_label = train_label[5800:]  
train_data = train_data[:5800, :]
train_label = train_label[:5800]
...
for epoch in range(num_epochs):
    ...
    if test_accuracy >= 0.70 and train_accuracy >= 0.70:
